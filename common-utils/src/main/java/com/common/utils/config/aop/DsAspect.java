...
import com.common.utils.config.DynamicDataSourceContextHolder;
...
public class DsAspect {
	...
	@Pointcut("execution(public * com.common.utils.mapper..*.*(..)) " +
            "|| execution(public * com.common.utils.methodLog.mapper.*.*(..))")
